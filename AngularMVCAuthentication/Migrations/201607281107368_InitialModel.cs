namespace AngularMVCAuthentication.Migrations
{
    ...
    public partial class InitialModel : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        SeccionEventoId = c.Int(nullable: false),
                        ApplicationUser_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.EventoId)
                .ForeignKey("dbo.AspNetUsers", t => t.ApplicationUser_Id)
                .ForeignKey("dbo.SeccionEventoes", t => t.SeccionEventoId, cascadeDelete: true)
                .Index(t => t.SeccionEventoId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Eventoes", "ApplicationUser_Id", "dbo.AspNetUsers");
